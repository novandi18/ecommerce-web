...
<section class="bg-light py-2 my-4 container d-flex justify-content-center" style="border: 1px solid #ddd; border-radius: 25px">
  <nav class="nav">
    ...
    <a class="nav-link <?= $_SERVER["REQUEST_URI"] == '/profile/transaction/process' ? 'font-weight-bold' : '' ?>" style="color: black;" href="/profile/transaction/processed">Processed</a>
        ...
        <tbody>
          ...
          foreach ($transactions as $transaction) : ?>
            ...
            <tr>
              ...
              <td><span class="badge badge-warning">waiting for payment</span></td>
